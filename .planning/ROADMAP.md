...
2. ✅ **Multi-stage Dockerfile** — `FROM golang:1.25-alpine AS builder`: copies source, runs static build; `FROM nicolaka/netshoot:v0.15`: copies both binaries. Comment block explaining why two stages and why `netshoot` as runtime.
